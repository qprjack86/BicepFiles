...
resource compute_AvailabilitySet_FG 'Microsoft.Compute/availabilitySets@2021-07-01' = {
...
resource routeTableProtectedA 'Microsoft.Network/routeTables@2020-04-01' = {
...
resource routeTableProtectedB 'Microsoft.Network/routeTables@2020-04-01' = {
...
resource routeTableSpoke1 'Microsoft.Network/routeTables@2020-04-01' = {
...
resource routeTableSpoke2 'Microsoft.Network/routeTables@2020-04-01' = {
...
resource vnet 'Microsoft.Network/virtualNetworks@2020-04-01' = if (vnetNewOrExisting == 'new') {
  name: vnetNamevar
  location: location
  properties: {
    addressSpace: {
...
resource vnetName_hubtoSpoke1Peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2020-04-01' = if (vnetNewOrExisting == 'new') {
  parent: vnet
...
resource vnetName_hubtoSpoke2Peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2020-04-01' = if (vnetNewOrExisting == 'new') {
  parent: vnet
...
resource vnetNameSpoke1_resource 'Microsoft.Network/virtualNetworks@2020-04-01' = if (vnetNewOrExistingSpoke1 == 'new') {
...
resource vnetNameSpoke1_spoke1toHubPeering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2020-04-01' = if (vnetNewOrExistingSpoke1 == 'new') {
...
resource vnetNameSpoke2_resource 'Microsoft.Network/virtualNetworks@2020-04-01' = if (vnetNewOrExistingSpoke2 == 'new') {
...
resource vnetNameSpoke2_spoke2toHubPeering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2020-04-01' = if (vnetNewOrExistingSpoke2 == 'new') {
...
resource internalLB 'Microsoft.Network/loadBalancers@2020-04-01' = {
  name: internalLBName
  location: location
  tags: {
    provider: toUpper(fortinetTags.provider)
...
resource publicIP 'Microsoft.Network/publicIPAddresses@2020-04-01' = if (publicIPNewOrExisting == 'new') {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
...
resource publicIP2 'Microsoft.Network/publicIPAddresses@2020-04-01' = if (publicIP2NewOrExisting == 'new') {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
...
resource publicIP3 'Microsoft.Network/publicIPAddresses@2020-04-01' = if (publicIP3NewOrExisting == 'new') {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
...
resource externalLB 'Microsoft.Network/loadBalancers@2020-04-01' = {
  name: externalLBName
  location: location
  tags: {
    provider: toUpper(fortinetTags.provider)
...
resource fgaNic1 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgaNic1Name
...
resource fgbNic1 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgbNic1Name
...
resource fgaNic2 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgaNic2Name
...
resource fgbNic2 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgbNic2Name
...
resource fgaNic3 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgaNic3Name
...
resource fgbNic3 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgbNic3Name
...
resource fgaNic4 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgaNic4Name
...
resource fgbNic4 'Microsoft.Network/networkInterfaces@2020-04-01' = {
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
  name: fgbNic4Name
...
resource fgaVm 'Microsoft.Compute/virtualMachines@2021-07-01' = {
  name: fgaVmName
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
...
resource fgbVm 'Microsoft.Compute/virtualMachines@2021-07-01' = {
  name: fgbVmName
  tags: {
    provider: toUpper(fortinetTags.provider)
  }
